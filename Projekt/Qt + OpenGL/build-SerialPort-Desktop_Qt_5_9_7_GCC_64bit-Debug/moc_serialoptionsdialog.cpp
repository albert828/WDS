/****************************************************************************
** Meta object code from reading C++ file 'serialoptionsdialog.h'
**
...
#include "../SerialPort/serialoptionsdialog.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'serialoptionsdialog.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(2, 42, 0) // ""
    ...
    "SerialOptionsDialog\0on_pushButton_clicked\0"
    ""
};
...
void SerialOptionsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SerialOptionsDialog *_t = static_cast<SerialOptionsDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
